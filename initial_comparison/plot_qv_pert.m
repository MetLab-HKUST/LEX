...
qvplex1 = ncread("LEX_dx100dz100_no_noise_SSPRK3dt5\lex_out_0000.nc", "qv_now");
qvplex2 = ncread("LEX_dx600dz300_no_noise_SSPRK3dt15\lex_out_0000.nc", "qv_now") ;
...
colormap(flip(centered2("RdBu", 80)))
clim([0, 2.3])
xlim([-6, 6])
xticks([-6, -3, 0, 3, 6])
ylim([0.15, 12])
...
qvplex1 = ncread("LEX_dx100dz100_no_noise_SSPRK3dt5\lex_out_0040.nc", "qv_now") ;
qvplex2 = ncread("LEX_dx600dz300_no_noise_SSPRK3dt15\lex_out_0040.nc", "qv_now") ;
...
qvplex1 = ncread("LEX_dx100dz100_no_noise_SSPRK3dt5\lex_out_0080.nc", "qv_now") ;
qvplex2 = ncread("LEX_dx600dz300_no_noise_SSPRK3dt15\lex_out_0080.nc", "qv_now") ;
...
qvplex1 = ncread("LEX_dx100dz100_no_noise_SSPRK3dt5\lex_out_0120.nc", "qv_now");
qvplex2 = ncread("LEX_dx600dz300_no_noise_SSPRK3dt15\lex_out_0120.nc", "qv_now") ;
