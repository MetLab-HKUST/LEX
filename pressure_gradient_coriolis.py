...
def pressure_gradient_force_horizontal(pi0, pip, theta, x3d, y3d):
    """ Calculate the horizontal pressure gradient force for the momentum equations
    ...
    pres_grad4v = -nl.Cp * 0.5 * (theta[nl.ngx:-nl.ngx, nl.ngy:-(nl.ngy-1), nl.ngz:-nl.ngz] +
                                  theta[nl.ngx:-nl.ngx, nl.ngy-1:-nl.ngy, nl.ngz:-nl.ngz]) * dpi_dy
    return pres_grad4u, pres_grad4v


def pressure_gradient_force_vertical(pip, theta, z3d):
    """ Calculate the vertical pressure gradient force for the momentum equations
